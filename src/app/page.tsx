            ...
            <article id='talents' className='article-talents'>
                ...
                <div className='talents'>
                    <section className='skill-card text-blackish pb-5 hover:shadow hover:scale-105 transition duration-500 ease-in-out' > 
                        <Image src={'/web-development-.png'} className='w-full ' width={100} height={100} alt='' quality={100} />
                    ...
                    <section className='skill-card text-blackish pb-5 hover:shadow hover:scale-105 transition duration-500 ease-in-out' >
                    <Image src={'/Data-Science-.png'} className='w-full ' width={100} height={100} alt='' quality={100} />
                    ...
                    <section className='skill-card text-blackish pb-5 hover:shadow hover:scale-105 transition duration-500 ease-in-out' >
                    <Image src={'/cloud-computing-.png'} className='w-full ' width={100} height={100} alt='' quality={100} />
                    ...
                    <section className='skill-card text-blackish pb-5 hover:shadow hover:scale-105 transition duration-500 ease-in-out' >
                    <Image src={'/UX-UI-Design.png'} className='w-full ' width={100} height={100} alt='' quality={100} />
                    ...
                    <section className='skill-card text-blackish pb-5 hover:shadow hover:scale-105 transition duration-500 ease-in-out' >
                    <Image src={'/video-editing.jpg'} className='w-full ' width={100} height={100} alt='' quality={100} />
                    ...
                    <section className='skill-card text-blackish pb-5 hover:shadow hover:scale-105 transition duration-500 ease-in-out' >
                    <Image src={'/Content-marketing.png'} className='w-full ' width={100} height={100} alt='' quality={100} />
